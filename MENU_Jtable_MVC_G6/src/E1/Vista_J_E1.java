...
public class Vista_J_E1 extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        CuadroPrimer.setText(String.valueOf("")); //Aqui no arroja error al agragar un registro con los campos vacios por que no se hace ninguna conversion solo se obtiene el valor de los campos 
