...
package PAQ_MENU_J_G6;

import E9.vista;
import E8.Vista_J_E8;
import E7.Vista_J_E7;
import E6.Vista_J_E6;
import E5.Vista_J_E5;
import E4.Vista_J_E4;
import E3.Vista_J_E3;
import E2.Vista_J_E2;
import E1.Vista_J_E1;
import javax.swing.JOptionPane;


public class Vista_Menu_J_G6 extends javax.swing.JFrame {

    public Vista_Menu_J_G6() {
        initComponents();
        this.setLocationRelativeTo(null);
        Campo_Opcion_.requestFocus(); //Se aplica el metodo request focus para que siempre que se muestre el jframe de menu este activo el campo de texto
    }
    ...
    private void initComponents() {
        ...
        Boton_salir_del_todo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_Menu_J_G6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_Menu_J_G6().setVisible(true);
            }
        });
    }
